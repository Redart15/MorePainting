...
The config and all textured need to be places in `assets/minecraft/textures/art/` and the config has to be named `painting.toml`.
...
A: Make sure that the configuration is in `assets/minecraft/textures/art/`.  
