...
public class EntityPaintingRendererMixin {
	...
	@WrapOperation(method = "render(Lnet/minecraft/client/render/tessellator/Tessellator;Lnet/minecraft/core/entity/EntityPainting;DDDFF)V",
		at = @At(
			value = "INVOKE",
			target = "Lnet/minecraft/client/render/entity/EntityRendererPainting;renderArt(Lnet/minecraft/client/render/tessellator/Tessellator;Lnet/minecraft/core/entity/EntityPainting;IILnet/minecraft/client/render/texture/stitcher/IconCoordinate;)V"))
	private void rerenderArt(
		EntityRendererPainting entityPaitingRenderer,
		Tessellator tessellatorGeneral,
	...
	@WrapOperation(method = "render(Lnet/minecraft/client/render/tessellator/Tessellator;Lnet/minecraft/core/entity/EntityPainting;DDDFF)V",
		at = @At(value = "INVOKE", target = "Lnet/minecraft/client/render/entity/EntityRendererPainting;renderBorder(Lnet/minecraft/core/entity/EntityPainting;II)V"))
